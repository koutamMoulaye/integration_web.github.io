(function($) {
    $.fn.htmlNumberSpinner = function () {
        ...
        incrementerEl$.css({"background-color":"", "color":"hsl(26, 100%, 55%)",});
        decrementerEl$.css({"background-color":"", "color":"hsl(26, 100%, 55%)", "font-size":"25px",});
        numberInput$.css({
            "background-color":"rgba(247,248,253,255)",
            "border": "1px solid",
            "color":"black",
            "text-align":"center",
            "width":"30px",
